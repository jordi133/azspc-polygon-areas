...
class PolygonGeneratorTest extends WordSpec{
  ...
  "triangleBasedGenerator" should {
    ...
    "generate a valid polygon in a square for n=105" in {
      val pg = PolygonGenerator.generatePolygonInSquare(PolygonGenerator.triangleBasedGenerator(PointGenerator.generateRandomPoints()))(105)
      println(pg)
    }
    "generate a valid polygon with combine for n=105" in {
      ...
      val pg = PolygonGenerator.triangleBasedGenerator(pointGenerator)
      println(pg)
    }
  }
