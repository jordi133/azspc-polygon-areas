...
object Gui extends JFXApp {
  ...
  def refreshPolygonOfSize(i: Int): Unit = {
    val pointsLeft = Vector(Point(3,2), Point(9,7), Point(14,10), Point(21,5), Point(19,8), Point(17,9), Point(10,18), Point(18,12), Point(20,21), Point(26,23), Point(22,22), Point(15,19), Point(16,14), Point(13,17), Point(6,20), Point(8,16), Point(5,13), Point(12,15), Point(11,11), Point(7,6), Point(4,4), Point(2,3), Point(1,46), Point(45,47), Point(35,38), Point(34,41), Point(27,43), Point(39,45), Point(24,44), Point(29,42), Point(28,39), Point(41,37), Point(32,32), Point(23,25), Point(30,30), Point(25,24), Point(33,29), Point(36,33), Point(38,28), Point(31,27), Point(37,26), Point(44,34), Point(40,31), Point(42,35), Point(43,40), Point(46,36), Point(47,1))
